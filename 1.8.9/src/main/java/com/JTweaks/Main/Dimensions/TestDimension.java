...
import com.JTweaks.Main.Dimensions.Portals.TeleporterDimensionMod;
...
public static class WorldProviderMod extends WorldProvider{
    ...
    public IChunkProvider createChunkGenerator(){
        return new ChunkProviderModded(this.worldObj, this.worldObj.getSeed()-17594);
    }
...
public static class WorldGenSchematicNo0 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random random, int i2, int j_unused, int k2)
    {
...
public static class ChunkProviderModded implements IChunkProvider {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        int var4 = par2 * 16;
		int var5 = par3 * 16;
        new WorldGenSchematicNo0().generate(this.worldObj, rand, var4, 0, var5);


        doGen = TerrainGen.decorate(worldObj, hellRNG, k, l, EventType.SHROOM);
/*        if (doGen && this.hellRNG.nextInt(1) == 0)
        ...
        WorldGenMinable worldgenminable = new WorldGenMinable(Blocks.dirt, 13);
        int j2;
        ...
        for (k1 = 0; k1 < 16; ++k1)
        {
            ...
            i2 = this.hellRNG.nextInt(108) + 10;
            j2 = l + this.hellRNG.nextInt(16);
            (new WorldGenHellLava(Blocks.water, true)).generate(this.worldObj, this.hellRNG, l1, i2, j2);
        }
